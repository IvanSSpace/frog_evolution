...
| 23 | Onboarding flow (soft 4-beat) | **in progress** — Plans 23-01/02/03/05/04 complete; 23-06 finalize pending. 5/6 REQ-IDs (PHASE23-STATE, PHASE23-CONTROLLER, PHASE23-BEAT1-WELCOME, PHASE23-BEAT4-LOCATION, PHASE23-BEAT3-MERGE). Plan 23-04 (2026-05-18): Beat 3 интерактивная merge demo — GhostFrogTrail (semi-transparent frog clone, QuadraticBezier arc, loops=3 с pauses), 2 TutorialPulseRing вокруг L1 frogs (reused from 23-03, radius=38px), MergeHintOverlay pill «Перетащи одну на другую», MergeSuccessToast pink one-shot, MergeController emits tutorial:firstMerge на любой первый merge (idempotent). Dismiss: реальный merge OR 8с auto-fade. Frog pickup во время demo cancel'ит ghost (rings stay). |
...
| **Subtotal** | — | **12 commits** | **12 created + 16 modified** | OK (Plan 23-04 build clean; 23-02 measure still pending) |

**Phase 23 REQ coverage so far:** 5/6 ✓ (PHASE23-STATE, PHASE23-CONTROLLER, PHASE23-BEAT1-WELCOME, PHASE23-BEAT4-LOCATION, PHASE23-BEAT3-MERGE). Remaining: PHASE23-BEAT2-TAPHINT (Plan 23-03 — assume mapped) + Plan 23-06 finalize.
