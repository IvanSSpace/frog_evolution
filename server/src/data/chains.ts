...
const QUESTS_RAW: QuestConfigSerialized[] = [
  ...
  // mechanidons
  { id: 'mechanidons_module_delivery', raceId: 'mechanidons', type: 'delivery', target: { kind: 'serum_count', element: 'mechanical', value: 5 }, reward: { kind: 'essence', value: 1 }, description_key: 'quests.mechanidons_module_delivery.description', short_key: 'quests.mechanidons_module_delivery.short', difficulty: 'easy' },
  ...
  { id: 'tenebrians_last_shard', raceId: 'tenebrians', type: 'delivery', target: { kind: 'serum_count', element: 'shadow', value: 5 }, reward: { kind: 'gold', value: 10000000 }, description_key: 'quests.tenebrians_last_shard.description', short_key: 'quests.tenebrians_last_shard.short', difficulty: 'easy' },
  ...
  { id: 'timeweavers_spiral_link', raceId: 'timeweavers', type: 'delivery', target: { kind: 'serum_count', element: 'void', value: 5 }, reward: { kind: 'gold', value: 10000000 }, description_key: 'quests.timeweavers_spiral_link.description', short_key: 'quests.timeweavers_spiral_link.short', difficulty: 'easy' },
