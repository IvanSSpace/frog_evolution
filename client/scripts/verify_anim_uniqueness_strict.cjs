...
// Финальный texture refine pass добавлен в Plan 06 для стабилизации 984/984
// texture unique после anim+sound mutation. Anim signature space достаточен
// чтобы absorb эти финальные re-mutations без потери uniqueness.
refineTextureSeeds()
refineAnimSeeds()
refineSoundSeeds()
refineTextureSeeds()
