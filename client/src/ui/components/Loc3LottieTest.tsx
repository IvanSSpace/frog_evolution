...
// Активный диапазон кадров. Файл: ip=60 op=240, fr=60 (плеер показывает 0–180
// относительно ip). Автор: цикл должен кончаться на кадре 137/180 (относит.) →
// абсолютный кадр = ip + 137 = 197. Луп = [60, 197].
const SEG_START = 60
const SEG_END = 197
