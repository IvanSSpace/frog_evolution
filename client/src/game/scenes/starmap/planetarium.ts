...
// 2026-06-02: батч-режим возвращён (0.35) — на дальнем zoom 600+ контейнеров в
// render tree давали лаги; ниже 0.35 планеты рендерятся как batch-точки (1 draw
// call). Чтобы взаимодействовать — зумишь ближе (планеты становятся контейнерами).
