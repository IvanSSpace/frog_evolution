...
export const FROG_LEVELS: readonly FrogLevelConfig[] = [
  ...
  },
  {
    ...
    name: 'Глазастик',
    size: 1.8, // 2026-05-28: L8 1.6→1.8
  ...
  // Палитра — продолжение жёлто-оливковой гаммы локации 1, тёмные оттенки.
  {
    ...
    name: 'Квакатлас',
    size: 1.28, // 2026-05-28: 0.98 + 0.3 = 1.28
  ...
  },
  {
    ...
    name: 'Лягобог',
    size: 1.6, // 2026-05-28: 1.75 − 0.15 = 1.6
  ...
  },
  {
    ...
    name: 'Вселенжаб',
    size: 1.75, // 2026-05-28: 1.65 + 0.1 = 1.75
  ...
  },
  {
    ...
    name: 'Уроборосква',
    size: 1.5, // 2026-05-28: 1.4 + 0.1 = 1.5
  ...
  },
  {
    ...
    name: 'Призмоляг',
    size: 1.528, // 2026-05-28: 1.428 + 0.1 = 1.528
